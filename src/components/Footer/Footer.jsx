...
const Footer = () => {
  ...
  const privacyPolicy = {
    ...
    content: (
      <>
        <p>At AnimeStore, your privacy is our priority. We collect information to process your orders and improve your experience.</p>
  ...
  const termsOfUse = {
    ...
    content: (
      <>
        <p>Welcome to AnimeStore. By using our site, you agree to the following conditions:</p>
        ...
        <p><strong>2. Intellectual Property:</strong> All product images, characters, and logos are the property of their respective owners and are used for descriptive purposes. The design of our site is the property of AnimeStore.</p>
